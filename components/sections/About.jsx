...
const About = () => {
  ...
  const socialProfiles = [
    ...
    { name: 'LinkedIn', icon: '/icons/linkedin.svg', url: 'www.linkedin.com/in/lakshya-shukla-140983250' },
  ...
  return (
    <section id="about" className="relative bg-black py-24 overflow-hidden px-12">
      {/* Background animation elements */}
      <div className="absolute inset-0">
        <div className="absolute -bottom-48 -left-48 w-96 h-96 rounded-full bg-purple-700/20 blur-3xl"></div>
        <div className="absolute -top-48 -right-48 w-96 h-96 rounded-full bg-indigo-700/20 blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div 
          ref={headingRef} 
          className="opacity-0 -translate-y-10 transition-all duration-1000 mb-12 text-center"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-20">
          ...
          <div 
            ref={bioRef} 
            className="col-span-1 md:col-span-2 opacity-0 translate-x-10 transition-all delay-300"
          >
            <div className="bg-gray-900/50 backdrop-blur-lg rounded-2xl p-8 border border-gray-800 shadow-xl hover:shadow-purple-500/10 transition-all">
          ...
          <div className="col-span-1">
            ...
            >
              <div className="bg-gray-900/50 backdrop-blur-lg rounded-2xl p-8 border border-gray-800 shadow-xl hover:shadow-cyan-500/10 transition-all duration-500 mb-6">
                <h3 className="text-2xl font-semibold text-white mb-6">Contact Info</h3>
                
                <div className="space-y-6">
                  {/* Location */}
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0 bg-gray-800 p-2 rounded-lg mt-1">
                    ...
                    <div>
                      <span className="block text-sm text-gray-400 font-medium">Location</span>
                      <span className="block text-white mt-1">Saripura Road, Alamnagar , Lucknow , 226017</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@example.com" className="block text-white mt-1 hover:text-cyan-400 transition-colors">lakshyashukla31@gmail.com</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0 bg-gray-800 p-2 rounded-lg mt-1">
                      <svg className="w-5 h-5 text-pink-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                    </div>
                    <div>
                      <span className="block text-sm text-gray-400 font-medium">Phone</span>
                      <span className="block text-white mt-1">+91 9453805716</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="bg-gray-900/50 backdrop-blur-lg rounded-2xl p-8 border border-gray-800 shadow-xl hover:shadow-pink-500/10 transition-all duration-500">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {socialProfiles.map((profile) => (
                    <Link 
                      ...
                      className="flex flex-col items-center p-4 bg-gray-800/50 rounded-xl hover:bg-gray-800 transform hover:scale-105 transition-all duration-300"
                    >
                      <div className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center mb-2 group-hover:bg-gray-600">
                        <div className="w-6 h-6 text-gray-200">
                          {/* Custom SVG based on platform name */}
                          {profile.name === 'GitHub' && (
                      ...
                      <span className="text-gray-300 font-medium text-sm">{profile.name}</span>
                    </Link>
                  ))}
                </div>
              </div>
