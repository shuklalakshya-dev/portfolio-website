...
const HeroSection = () => {
 ...
 const btnRef = useRef(null);
  ...
  return (
    <section className="relative bg-black min-h-screen flex items-center overflow-hidden px-5">
      {/* Animated background elements */}
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-1/4 left-1/5 w-64 h-64 rounded-full bg-indigo-500 mix-blend-lighten filter blur-3xl animate-blob"></div>
        <div className="absolute top-1/3 right-1/5 w-72 h-72 rounded-full bg-pink-500 mix-blend-lighten filter blur-3xl animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-1/4 left-1/3 w-80 h-80 rounded-full bg-cyan-500 mix-blend-lighten filter blur-3xl animate-blob animation-delay-4000"></div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center px-10">
          ...
          <div className="text-center md:text-left order-2 md:order-1">
            <div ref={nameRef} className="opacity-0 translate-y-8 transition-all duration-700 delay-300">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-4 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">
                Lakshya Shukla
              </h1>
            </div>
            ...
            <div ref={btnRef} className="opacity-0 translate-y-8 transition-all duration-700 delay-900">
              <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                {/* Use the button approach with programmatic navigation for more control */}
                  <button
                  onClick={handleContactClick}
                  className="px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium rounded-lg transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-indigo-500/20 inline-block text-center"
                >
                  Contact Me
                </button> 
               </div> 
          ...
          <div className="order-1 md:order-2 px-20">
            <div className="relative mx-auto md:mx-0 max-w-md">
              ...
              <div ref={imageRef} className="relative z-10 animate-float">
                <div className=" w-64 h-64 md:w-80 md:h-80 rounded-3xl overflow-hidden shadow-2xl transform rotate-3 transition duration-500">
                  <div className="w-full h-full relative bg-gradient-to-tr from-indigo-600 to-purple-600 p-2 rounded-3xl">
                    <div className="w-full h-full overflow-hidden rounded-2xl">
                      ...
                      {/* Option 2: Or if you prefer standard img tag, remove the priority attribute */}
                      {/* <img
                        src="/profile.jpg" 
                        alt="Lakshya Shukla - Profile" 
                        width={400} 
                ...
                {/* Decorative elements */}
                <div className="absolute -top-6 -right-6 w-20 h-20 bg-pink-500 rounded-full blur-xl opacity-70 animate-pulse-slow"></div>
                <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-indigo-500 rounded-full blur-xl opacity-70 animate-pulse-slow animation-delay-2000"></div>
                
                {/* Geometric shapes */}
                <div className="absolute -right-12 top-1/3 w-8 h-8 border-4 border-indigo-400 rounded-lg animate-bounce-slow"></div>
                <div className="absolute -left-10 bottom-1/4 w-6 h-6 bg-purple-400 rounded-full animate-bounce-slow animation-delay-1000"></div>
                <div className="absolute right-1/4 -bottom-6 w-10 h-10 border-4 border-pink-400 rounded-full animate-bounce-slow animation-delay-3000"></div>
              </div>
            </div>
          </div>
        </div>
